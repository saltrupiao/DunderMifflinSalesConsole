                ...
                <div class="container mt-3">
                    <form action="../controller/branchesController.php" class="was-validated" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="bchState" class="custom-select mb-3" required>
            ...
            <div class="modal-body">
                <div class="container mt-3">
                    <form action="../controller/branchesController.php" class="was-validated" method="post">
                        ...
                        <div class="form-group">
                            <label for="bchName">Branch&nbsp;Name:</label>
                            <input type="text" class="form-control" placeholder="Enter branch name" name="bchName">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="form-group">
                            <label for="bchPOC">Point&nbsp;of&nbsp;Contact:</label>
                            <input type="text" class="form-control" placeholder="Enter POC" name="bchPOC">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="form-group">
                            <label for="bchPhone">Phone:</label>
                            <input type="tel" class="form-control" placeholder="Format: 123-456-7890" name="bchPhone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="form-group">
                            <label for="bchState">State:</label>
                            <select name="bchState" class="custom-select mb-3">
                                <option selected></option>
                                <option value="AL">Alabama</option>
                                <option value="AK">Alaska</option>
                                <option value="AZ">Arizona</option>
                        ...
                        <div class="form-group">
                            <label for="bchCity">City:</label>
                            <input type="text" class="form-control" placeholder="Enter city" name="bchCity">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="form-group">
                            <label for="bchStreet">Street:</label>
                            <input type="text" class="form-control" placeholder="Enter street address" name="bchStreet">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="form-group">
                            <label for="bchZipcode">Zipcode:</label>
                            <input type="number" class="form-control" placeholder="Enter zipcode" name="bchZipcode">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
